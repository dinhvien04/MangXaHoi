<div class="hb-auth-page">
    <section class="hb-auth-brand-panel">
        ...
        <div class="hb-auth-brand-copy"><span class="hb-auth-kicker">JOIN THE COMMUNITY</span><h1>Một tài khoản.<br>Nhiều kết nối.</h1><p>Tạo hồ sơ Novera để đăng bài, theo dõi bạn bè và bắt đầu những cuộc trò chuyện mới.</p></div>
        <div class="hb-auth-social-preview"><div class="hb-preview-avatar">N</div><div><strong>Novera Community</strong><small>Luôn chào đón thành viên mới</small></div><p>Chào mừng bạn 👋</p><span>Hãy tạo tài khoản và bắt đầu chia sẻ.</span></div>
    </section>
    <section class="hb-auth-form-panel">
        <form class="hb-auth-card hb-auth-card-tall" method="post" action="?action=signup">
            ...
            <h2>Tạo tài khoản mới</h2><p class="hb-auth-subtitle">Tham gia cộng đồng Novera chỉ trong vài bước.</p>
