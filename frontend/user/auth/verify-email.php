<div class="hb-auth-page">
    <section class="hb-auth-brand-panel">
        ...
        <div class="hb-auth-brand-copy"><span class="hb-auth-kicker">ONE LAST STEP</span><h1>Xác minh email.<br>Mở khóa Novera.</h1><p>Hoàn tất bước cuối để sử dụng feed, tương tác, tìm kiếm và nhắn tin.</p></div>
    ...
    <section class="hb-auth-form-panel">
        <div class="hb-auth-card">
            ...
            <div class="hb-auth-security"><i class="bi bi-check2-circle"></i><span>Xác minh xong sẽ mở khóa toàn bộ tính năng của tài khoản Novera.</span></div>
        </div>
    </section>
</div>
