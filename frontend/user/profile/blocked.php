<div class="hb-state-page">
    <section class="hb-card hb-state-card">
        ...
        <span class="hb-state-eyebrow">NOVERA SOCIAL</span>
        <h1>Tài khoản của bạn đã bị chặn</h1>
        <p>Xin chào <?= e($user['first_name'] . ' ' . $user['last_name']) ?>. Bạn hiện không thể sử dụng các tính năng của Novera Social.</p>
