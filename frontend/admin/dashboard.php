...
<div class="hb-admin-shell">
    <aside class="hb-admin-sidebar">
        ...
        <nav class="hb-admin-nav">
            ...
            <a href="../"><span><i class="fas fa-globe"></i></span> Mở mạng xã hội</a>
        </nav>
        <div class="hb-admin-sidebar-note"><small>Tài khoản hiện tại</small><strong>Administrator</strong></div>
        ...
        <main class="hb-admin-content">
            ...
            <?php if ($isEdit): ?>
                <section class="hb-admin-settings-card">
                    <div class="hb-admin-section-head"><div><h2>Thông tin quản trị viên</h2><p>Cập nhật tên, email hoặc mật khẩu của chính tài khoản đang đăng nhập.</p></div></div>
