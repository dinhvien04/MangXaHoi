  ...
  <div class="offcanvas-body">
    ...
    <div class="d-flex justify-content-between align-items-center border-bottom p-3">
      <div class="d-flex align-items-center">
        <img src="assets/images/profile/<?= e($fuser['profile_pic']) ?>" alt="" height="40" width="40" class="rounded-circle border">
        <div class="ms-2">
          <a href="?u=<?= rawurlencode($fuser['username']) ?>" class="text-decoration-none text-dark fw-bold">
            <?= e($fuser['first_name']) ?> <?= e($fuser['last_name']) ?>
          </a>
          <p class="mb-0 text-muted small <?= $not['read_status'] ? 'text-secondary' : '' ?>">
            <?= e($not['message']) ?>
          </p>
          <time class="text-muted small timeago <?= $not['read_status'] ? 'text-secondary' : '' ?>" datetime="<?= e($time) ?>"></time>
        </div>
      </div>
      <div>
...
<script src="assets/js/features/posts.js?v=<?= time() ?>"></script>
<script src="assets/js/features/follow.js?v=<?= time() ?>"></script>
<script src="assets/js/features/likes.js?v=<?= time() ?>"></script>
<script src="assets/js/features/comments.js?v=<?= time() ?>"></script>
<script src="assets/js/features/search.js?v=<?= time() ?>"></script>
<script src="assets/js/features/notifications.js?v=<?= time() ?>"></script>
<script src="assets/js/features/messages.js?v=<?= time() ?>"></script>
